...
class ScriptedAssetLibrary extends ModsFolderLibrary {
	...
	public function new(scriptName:String, args:Array<Dynamic> = null, folderPath:String=null, libName:String="assets", ?modName:String) {
		if(folderPath == null) folderPath = #if mobile MobileUtil.getAssetDirectory() + #end "assets/";
